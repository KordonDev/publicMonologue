	...
	<body>
        ...
        <div class="contain-to-grid fixed">
            <nav class="top-bar" data-topbar role="navigation">
                <ul class="title-area">
                    <li class="name">
                        <h1><g:link controller="profile" action="show">${grailsApplication.config.blog.title}</g:link></h1>
                    </li> <!-- Remove the class "menu-icon" to get rid of menu icon. Take out "Menu" to just have icon alone  Kordon's public monologues-->
