...
set AGENT_STRING=-javaagent:%GRAILS_HOME:\=/%/lib/org.springframework/springloaded/jars/springloaded-1.2.1.RELEASE.jar -Xverify:none -Dspringloaded.synchronize=true -Djdk.reflect.allowGetCallerClass=true -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\org.codehaus.groovy\groovy-all\jars\groovy-all-2.3.7.jar;%GRAILS_HOME%\dist\grails-bootstrap-2.4.4.jar
